    ...
    documentation = {
        "routes": [
            ...
            },
            {
                "route": "/average_price",
                "method": "GET",
                "description": "Afficheles les prix moyens des produits en fonction de l'évolution des prix"
            },
            {
                "route": "/predict",
                "method": "GET",
                "description": "Affiche la prediction des prix pour le mois prochain"
            }
        ]
    }
